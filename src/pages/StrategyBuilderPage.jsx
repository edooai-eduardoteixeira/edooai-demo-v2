            ...
            <div style={{
              ...
              <div style={{
                ...
                gap: '10px 20px',
                  ...
                  {[
                    { label: 'Avg CAC', value: `$${cac}`, curve: dailyKPIs?.cac, invert: true,
                      desc: 'Customer Acquisition Cost — total spend divided by new active users. Lower is better.' },
                    { label: 'ROI', value: `${typeof roi === 'number' ? roi.toFixed(1) : roi}x`, curve: dailyKPIs?.roi, invert: false,
                      desc: 'Return on Investment — revenue generated by referred users divided by campaign spend.' },
                    { label: 'Conv rate', value: `${typeof convRate === 'number' ? convRate.toFixed(1) : convRate}%`, curve: dailyKPIs?.convRate, invert: false,
                      desc: 'Conversion Rate — percentage of contacted users who completed the referral journey.' },
                    { label: 'Fraud saved', value: `$${Math.round((fraudSaved || 0) / 1000)}K`, curve: dailyKPIs?.fraudSaved, invert: false,
