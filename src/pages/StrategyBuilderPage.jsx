                  ...
                  <div className={`${tl.messageBlock} ${tl.messageBlockTop}`}>
                    ...
                    <div className={tl.msgContent}>
                      ...
                      <div className={s1Combo.msg === 'ask' && s1Combo.ch === 'email' ? '' : tl.hidden}>
                        <div className={tl.devicePhone}><div className={tl.deviceStatusbar}><span>9:41</span><span></span></div><div className={tl.deviceScreen}><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#007AFF' }}><svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" /></svg></div><span className={tl.pushApp}>Mail</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>Gina, let&apos;s get that $211 back? 🍿</div><div className={tl.pushBody}>Netflix for free, Gina. One for you, one for a friend</div></div></div><div className={tl.deviceHomeBar}></div></div>
                      </div>
                      {/* Reminder · Push */}
                  ...
                  <div className={`${tl.messageBlock} ${tl.messageBlockTop}`}>
                    ...
                    <div className={tl.msgContent}>
                      ...
                      <div className={s3Combo.msg === 'success' && s3Combo.ch === 'sms' ? '' : tl.hidden}>
                        <div className={tl.devicePhone}><div className={tl.deviceStatusbar}><span>10:18</span><span></span></div><div className={tl.deviceScreen}><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#34C759' }}><svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" /></svg></div><span className={tl.pushApp}>Messages</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>NeoBank · 72589</div><div className={tl.pushBody}>You&apos;re in! 🍿 First transaction done — a free month of Netflix is yours. Gina gets one too. Welcome to NeoBank!</div></div></div><div className={tl.deviceHomeBar}></div></div>
                      </div>
                      {/* Success · Email */}
                      <div className={s3Combo.msg === 'success' && s3Combo.ch === 'email' ? '' : tl.hidden}>
                        <div className={tl.devicePhone}><div className={tl.deviceStatusbar}><span>10:18</span><span></span></div><div className={tl.deviceScreen}><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#007AFF' }}><svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" /></svg></div><span className={tl.pushApp}>Mail</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>Your free Netflix month is here! 🍿</div><div className={tl.pushBody}>Netflix on us. One for you, one for Gina</div></div></div><div className={tl.deviceHomeBar}></div></div>
                      </div>
                      {/* Reminder · Push */}
