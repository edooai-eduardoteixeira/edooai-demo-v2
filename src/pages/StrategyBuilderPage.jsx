                  ...
                  <div className={`${tl.messageBlock} ${tl.messageBlockTop}`}>
                    ...
                    <div className={tl.msgContent}>
                      ...
                      <div className={s3Combo.msg === 'success' && s3Combo.ch === 'push' ? '' : tl.hidden}>
                        <div className={tl.devicePhone}><div className={tl.deviceStatusbar}><span>10:18</span><span></span></div><div className={tl.deviceScreen}><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon}>N</div><span className={tl.pushApp}>NeoBank</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>Your Netflix is on us! 🍿</div><div className={tl.pushBody}>Huge win—you and Paul both just scored a free month of Netflix. Your reward is officially unlocked and ready to use in the app. Enjoy!</div></div><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon}>N</div><span className={tl.pushApp}>NeoBank</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>Netflix is officially unlocked! 📺</div><div className={tl.pushBody}>Nice move. Since you&apos;ve joined NeoBank, you and Gina both get a free month of Netflix. Head to the app to claim your reward and start streaming!</div></div></div><div className={tl.deviceHomeBar}></div></div>
                      </div>
                      {/* Success · SMS */}
                      <div className={s3Combo.msg === 'success' && s3Combo.ch === 'sms' ? '' : tl.hidden}>
                        <div className={tl.devicePhone}><div className={tl.deviceStatusbar}><span>10:18</span><span></span></div><div className={tl.deviceScreen}><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#34C759' }}><svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" /></svg></div><span className={tl.pushApp}>Messages</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>NeoBank · 72589</div><div className={tl.pushBody}>Huge win—you and Paul both just scored a free month of Netflix. Your reward is officially unlocked and ready to use in the app. Enjoy!</div></div><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#34C759' }}><svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" /></svg></div><span className={tl.pushApp}>Messages</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>NeoBank · 72589</div><div className={tl.pushBody}>Nice move. Since you&apos;ve joined NeoBank, you and Gina both get a free month of Netflix. Head to the app to claim your reward and start streaming!</div></div></div><div className={tl.deviceHomeBar}></div></div>
                      </div>
                      {/* Success · Email */}
                      <div className={s3Combo.msg === 'success' && s3Combo.ch === 'email' ? '' : tl.hidden}>
                        <div className={tl.devicePhone}><div className={tl.deviceStatusbar}><span>10:18</span><span></span></div><div className={tl.deviceScreen}><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#007AFF' }}><svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" /></svg></div><span className={tl.pushApp}>Mail</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>Your Netflix is on us! 🍿</div><div className={tl.pushBody}>Huge win—you and Paul both just scored a free month of Netflix. Your reward is officially unlocked and ready to use in the app. Enjoy!</div></div><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#007AFF' }}><svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" /></svg></div><span className={tl.pushApp}>Mail</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>Netflix is officially unlocked! 📺</div><div className={tl.pushBody}>Nice move. Since you&apos;ve joined NeoBank, you and Gina both get a free month of Netflix. Head to the app to claim your reward and start streaming!</div></div></div><div className={tl.deviceHomeBar}></div></div>
                      </div>
                      {/* Reminder · Push */}
                      <div className={s3Combo.msg === 'reminder' && s3Combo.ch === 'push' ? '' : tl.hidden}>
                        <div className={tl.devicePhone}><div className={tl.deviceStatusbar}><span>10:18</span><span></span></div><div className={tl.deviceScreen}><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon}>N</div><span className={tl.pushApp}>NeoBank</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>Almost there, Gina! 🍿</div><div className={tl.pushBody}>Paul hasn&apos;t completed their first transaction yet. Once they do, you both unlock a free month of Netflix. Hang tight!</div></div><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon}>N</div><span className={tl.pushApp}>NeoBank</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>Your Netflix month is waiting 🍿</div><div className={tl.pushBody}>Make your first transaction and unlock a free month of Netflix — for you and for Gina. Don&apos;t miss out!</div></div></div><div className={tl.deviceHomeBar}></div></div>
                      </div>
                      {/* Reminder · SMS */}
                      <div className={s3Combo.msg === 'reminder' && s3Combo.ch === 'sms' ? '' : tl.hidden}>
                        <div className={tl.devicePhone}><div className={tl.deviceStatusbar}><span>10:18</span><span></span></div><div className={tl.deviceScreen}><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#34C759' }}><svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" /></svg></div><span className={tl.pushApp}>Messages</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>NeoBank · 72589</div><div className={tl.pushBody}>Almost there! Paul hasn&apos;t completed their first transaction yet. Once they do, you both unlock a free month of Netflix. Hang tight!</div></div><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#34C759' }}><svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" /></svg></div><span className={tl.pushApp}>Messages</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>NeoBank · 72589</div><div className={tl.pushBody}>Your free Netflix month is waiting! 🍿 Make your first transaction to unlock it — Gina gets one too. Expires in 7 days.</div></div></div><div className={tl.deviceHomeBar}></div></div>
                      </div>
                      {/* Reminder · Email */}
                      <div className={s3Combo.msg === 'reminder' && s3Combo.ch === 'email' ? '' : tl.hidden}>
                        <div className={tl.devicePhone}><div className={tl.deviceStatusbar}><span>10:18</span><span></span></div><div className={tl.deviceScreen}><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#007AFF' }}><svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" /></svg></div><span className={tl.pushApp}>Mail</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>Almost there, Gina! 🍿</div><div className={tl.pushBody}>Paul hasn&apos;t completed their first transaction yet. Once they do, you both unlock a free month of Netflix. We&apos;ll let you know!</div></div><div className={tl.mockupPush}><div className={tl.pushHeader}><div className={tl.pushIcon} style={{ background: '#007AFF' }}><svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" /></svg></div><span className={tl.pushApp}>Mail</span><span className={tl.pushTime}>now</span></div><div className={tl.pushTitle}>A free Netflix month, one step away 🍿</div><div className={tl.pushBody}>Almost there — one transaction is all it takes to unlock a free month of Netflix for you and Gina. Don&apos;t miss out, it expires in 7 days!</div></div></div><div className={tl.deviceHomeBar}></div></div>
                      </div>
                    </div>
                  </div>
